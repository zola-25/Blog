...
Scenario: Search for an article that exists
	...
	Then The h2 text should equal Search Results
	And The search result h3 text should contain New Blog Site

@UsingFirefox
Scenario: Search for an article that doesn't exist
	Given I have entered Text with no article into the search box
	When I click search submit
	Then The h2 text should equal No results available for your search
